...
4. The [Build Packages GitHub Action](https://github.com/queze1/nixos-config/blob/main/.github/workflows/build-packages.yml) builds and pushes custom packages to the binary cache.
5. On an automated update pull request, a [GitHub Action](https://github.com/queze1/nixos-config/blob/main/.github/workflows/build-configurations.yml) builds and pushes all NixOS configurations to the binary cache to speed up updates.
